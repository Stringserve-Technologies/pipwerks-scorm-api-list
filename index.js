(function(e, a) { for(var i in a) e[i] = a[i]; }(exports, /******/ (function(modules) { // webpackBootstrap
	...
	/***/ function(module, exports) {
		...
		pipwerks.SCORM.data.score = function(value, maxValue) {
			var success = false,
				scorm = pipwerks.SCORM,
				trace = pipwerks.UTILS.trace,
				debug = scorm.debug,
				traceMsgPrefix = "SCORM.data.set('" + value + "') ";
			...
			if (scorm.connection.isActive) {
				...
				if (API) {
					...
					switch (scorm.version) {
						case "1.2":
							success = scorm.set('cmi.core.score.raw', value.toString());
							if (success && maxValue !== undefined) {
                        		scorm.set('cmi.core.score.max', maxValue.toString());
                    		}
							break;
						case "2004":
							success = scorm.set('cmi.score.raw', value.toString());
							if (success && maxValue !== undefined) {
                        		scorm.set('cmi.score.max', maxValue.toString());
                    		}
							break;
					}
		...
		pipwerks.SCORM.data.cumulativeScore = function(value, maxValue) {
			var success = false,
				scorm = pipwerks.SCORM,
				trace = pipwerks.UTILS.trace,
				debug = scorm.debug,
			...
			if (scorm.connection.isActive) {
				...
				if (API) {
					...
					switch (scorm.version) {
						case "1.2":
							if (scorm.get('cmi.core.score.raw') === undefined || 
								scorm.get('cmi.core.score.raw') === '' || 
								scorm.get('cmi.core.score.raw') === null){
								success = scorm.set('cmi.core.score.raw', value.toString());
							} else {
								var score =  parseInt(scorm.get('cmi.core.score.raw')) + value;
							...
							break;
						case "2004":
							if (scorm.get('cmi.score.raw') === undefined || 
								scorm.get('cmi.score.raw') === '' || 
								scorm.get('cmi.score.raw') === null){
								success = scorm.set('cmi.score.raw', value.toString());
							} else {
								var score =  parseInt(scorm.get('cmi.score.raw')) + value;
		...
		pipwerks.SCORM.data.maxScore = function(value) {
			var success = false,
				scorm = pipwerks.SCORM,
				trace = pipwerks.UTILS.trace,
				debug = scorm.debug,
			...
			if (scorm.connection.isActive) {
				...
				if (API) {
					...
					switch (scorm.version) {
						case "1.2":
							success = scorm.set('cmi.core.score.max', value.toString());
							break;
						case "2004":
							success = scorm.set('cmi.score.max', value.toString());
							break;
					}
		...
		pipwerks.SCORM.score = pipwerks.SCORM.data.score;
		pipwerks.SCORM.cumulativeScore = pipwerks.SCORM.data.cumulativeScore;
		pipwerks.SCORM.maxScore = pipwerks.SCORM.data.maxScore;
